    ...
    return GroundTruth(
        ...
        items=[
            PlantedItem(
                ...
                match_excerpt="9 mm solid nodule in the left lower lobe",
            ),
            PlantedItem(
                ...
                match_excerpt="outpatient colonoscopy in 6",
            ),
            PlantedItem(
                ...
                match_excerpt="Apixaban held on admission",
            ),
            PlantedItem(
                ...
                surfaced=True, live="precompute",
                match_excerpt="Blood cultures x2 drawn for temperature",
            ),
            PlantedItem(
                ...
                surfaced=True, live="precompute",
                match_excerpt="Creatinine 1.6 mg/dL",
            ),
        ],
    )
